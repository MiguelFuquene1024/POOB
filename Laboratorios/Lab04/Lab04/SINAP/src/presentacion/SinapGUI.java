    ...
    private void prepareAcciones(){
        ...
        botonListar.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ev){
				try{
					...
					Registro.registre(exception);
					JOptionPane.showMessageDialog( null,
					"Opsss ocurrio un error al momento de Listar", "Error:", JOptionPane.ERROR_MESSAGE );
					System.exit(0);
				}
            }
        ...
        botonAdicionar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev){
				...
				catch( SINAPExcepcion exception){
					Registro.registre(exception);
        ...
        busquedaTexto.getDocument().addDocumentListener(new DocumentListener(){
            public void changedUpdate(DocumentEvent ev){
				try{
					...
					Registro.registre(exception);
					JOptionPane.showMessageDialog( null,
					"Opsss ocurrio un error al momento de Buscar", "Error:", JOptionPane.ERROR_MESSAGE );
				}
            }
