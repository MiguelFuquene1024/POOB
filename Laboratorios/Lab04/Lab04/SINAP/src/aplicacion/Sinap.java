...
public class Sinap{
    ...
    public void adicione(String nombre, String name,String ubicacion, String area, String descripcion) throws SINAPExcepcion{
		if ( "".equals(nombre) || "".equals(ubicacion ) ||
			"".equals(area )  || "".equals(descripcion )){
			throw new SINAPExcepcion( SINAPExcepcion.EMPTY_PARAMETERS);
		}
		if ( "".equals( name ) ){
			throw new SINAPExcepcion( SINAPExcepcion.EMPTY_INERNATIONAL_NAME);
		}
		if( getDetalles(nombre,  name )!=  null ){
			throw new SINAPExcepcion( SINAPExcepcion.DUPLICATED_AREA);
		}
