...
public class Bloque extends Elemento{
	...
	/**
	 * metodo que se encarga de establecer la imagen que tomara el bloque
	 * @param rute, la ruta de la imagen del bloque que tomara
	 * */
